...
use app\models\Eurocali\CategorySearch;
...
/**
 * EurocaliCategoryController implements the CRUD actions for Category model.
 */
class EurocaliCategoryController extends Controller
{
    /**
     * @inheritdoc
     */
