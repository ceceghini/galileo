...
use app\models\Eurocali\ProductSearch;
...
/**
 * EurocaliProductController implements the CRUD actions for Product model.
 */
class EurocaliProductController extends Controller
{
    /**
     * @inheritdoc
     */
